...
SECRET_KEY = 'django-insecure-hk(uaf#puaxp)l(+)qdeo5xxcn%7x22o2@j2+&ngvtd!h8ug%3'
...
SIMPLE_JWT = {
    ...
    'UPDATE_LAST_LOGIN': True,                       # Mettre à jour last_login lors de la connexion
}


AUTHENTICATION_BACKENDS = [
    'django.contrib.auth.backends.ModelBackend',  # Backend par défaut
    'authentication.backends.EmailBackend',      # Backend personnalisé pour l'email
]
...
LOGGING = {
    ...
    'root': {
        'handlers': ['console'],
        'level': 'DEBUG',  # Affiche tous les logs (DEBUG, INFO, WARNING, ERROR, CRITICAL)
    },
}"""